    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          data-title={curLocale}
          aria-label={t('changeLanguage', { locale: curLocale })}
        >
          <Languages aria-hidden="true" className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all" />
        </Button>
      </DropdownMenuTrigger>
